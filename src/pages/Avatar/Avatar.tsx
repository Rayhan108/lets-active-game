...
const Avatar = () => {
  ...
  // Check if avatar name is "Golden"
      ...
      <div className="grid grid-cols-5 gap-6">
        {filteredAvatars.map((avatar) => (
          <div
            ...
            `}
          >
            {/* Golden Badge - Only for Golden name */}
            {isGolden(avatar) && (
            ...
            <div className="flex items-center justify-between mb-1">
              <span
                className={`font-medium ${
                  isGolden(avatar) ? "text-amber-400" : "text-gray-400"
                }`}
              >
                {avatar.name}
              </span>
            ...
            <div
              className={`font-semibold mb-3 ${
                isGolden(avatar) ? "text-amber-400" : "text-blue-500"
              }`}
            >
            ...
            <div
              className={`flex items-center justify-between pt-2 border-t ${
                isGolden(avatar) ? "border-amber-500/30" : "border-gray-700"
              }`}
            >
              <button
